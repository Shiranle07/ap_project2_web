...
function TopNavbar({userData}){
    return(
        ...
        <div className="container-fluid">
            <a className="fakebook-brand m-1" href="#">
            <img src={logo} alt="Logo" width="50" height="44" className="d-inline-block align-text-top"></img>
            </a>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <form className="d-flex" role="search">
                        ...
                        <input className="form-control search-bar" type="search" placeholder="Search in Fakebook" aria-label="Search"></input>
                </form>
