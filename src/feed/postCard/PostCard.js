...
function PostCard({ _id, user_email, user_firstName, user_lastName, user_photo, postBody, postPhoto, likesNumber, publication_date_formatted, comments, onDeletePost, onEditPost, userData, addCommentToPost, deleteCommentFromPost, token}) {
