...
function PostCard({ user_firstName, user_lastName, user_photo, postBody, postPhoto, likesNumber, commantsNumber, publication_date }) {
    ...
    return (
        <div class="container mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div className="like-and-comment mt-2">
                        ...
                        <a href="#" class="card-link comments-info">{commantsNumber} comments</a>
                    </div>
                    <hr></hr>
                    <div className="btn-row d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-post-card align-items-center transparent-bg" onclick="openPostPage()" data-bs-toggle="modal" data-bs-target="#exampleModalToggle11">
            ...
            {/* <Post user_firstName = {userData.user_firstName} user_lastName = {userData.user_lastName} user_photo = {userData.user_photo} postBody = {postBody} postPhoto = {postPhoto} likesNumber = {likesNumber} commantsNumber = {commantsNumber} publication_date = {userData.user_firstName}/> */}
